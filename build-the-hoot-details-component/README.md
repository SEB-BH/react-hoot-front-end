...
Consider making a spinner with [this generator](https://www.w3schools.com/tools/tool_css_loader.php). Replace `Loading...` with this html element: `<div className="loader"></div>` and add the gnerated `css` to `App.css`.
